...
if __name__ == '__main__':
    ...
    v3model=mobilenet_v3_large(num_classes=8).to(global_config.DEVICE)
    ...
    # test(model, test_dataloader, r"F:/DigitalRecognition-master/model_params/" + global_config.MODEL_NAME + '.pt', writer, 0)